...
public class NotificationService : INotificationService {
    ...
    public void Notify(Notification notification) {
        ...
        ControlAppearance appearance = notification.Variant switch {
        ...
        IconElement? icon = notification.Variant switch {
            ToastVariant.Success => new SymbolIcon(SymbolRegular.CheckmarkCircle24, 32D),
            ToastVariant.Warning => new SymbolIcon(SymbolRegular.Warning24, 32D),
            ToastVariant.Error => new SymbolIcon(SymbolRegular.ErrorCircle24, 32D),
            ToastVariant.Info => new SymbolIcon(SymbolRegular.Info24, 32D),
            _ => null
        };
