...
public static class WpfPerformanceDiagnostics {
    ...
    public static void EnableDiagnostics() {
        ...
        System.Diagnostics.TextWriterTraceListener myTextListener = new System.Diagnostics.TextWriterTraceListener();
    ...
    private static void OutputDiagnosticInfo() {
        System.Diagnostics.Debug.WriteLine("=== WPF Performance Diagnostics ===");
        System.Diagnostics.Debug.WriteLine($"OS: {System.Environment.OSVersion}");
        System.Diagnostics.Debug.WriteLine($"Processor Count: {System.Environment.ProcessorCount}");
        System.Diagnostics.Debug.WriteLine($".NET Version: {System.Runtime.InteropServices.RuntimeInformation.FrameworkDescription}");
        System.Diagnostics.Debug.WriteLine("");
        System.Diagnostics.Debug.WriteLine("Drag-and-drop optimization is active");
        System.Diagnostics.Debug.WriteLine("Icon list uses lightweight 64x64px drag adorner");
        System.Diagnostics.Debug.WriteLine("====================================");
    }
